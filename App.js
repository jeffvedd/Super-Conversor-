...
import { 
  ...
  FlatList, 
  Alert,
  Clipboard // ✅ Import direto do react-native (não precisa de expo-clipboard!)
} from 'react-native';
...
const App = () => {
  ...
  // ✅ Nova função: usa Clipboard do React Native (sem dependência!)
  const copyPix = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* 🎯 Bloco Pix — agora SEM dependências externas */}
      <View style={styles.supportContainer}>
        <Text style={styles.supportText}>
          🌟 Apoie o desenvolvimento do projeto! Copie nossa chave Pix abaixo.
        </Text>
        <TouchableOpacity style={styles.pixButton} onPress={copyPix}>
          <Ionicons 
            name={copyStatus === 'copied' ? "checkmark-circle" : "clipboard-outline"} 
            size={20} 
            color="white" 
          />
        ...
        <Text style={styles.pixKey}>039.272.239-99</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  supportText: { fontSize: 15, color: '#5a52a5', textAlign: 'center', marginBottom: 15, lineHeight: 22 },
  pixButton: {
    flexDirection: 'row',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  pixButtonText: { fontSize: 16, fontWeight: 'bold', color: 'white', marginLeft: 8 },
  pixKey: { fontSize: 14, fontWeight: '600', color: '#6C63FF', fontFamily: 'monospace' },
