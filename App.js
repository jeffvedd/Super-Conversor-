...
// Configuração de IDs (dev usa teste, prod usa seu ID)
const BANNER_AD_UNIT_ID = __DEV__
  ? TestIds.BANNER
  : 'ca-app-pub-5461017538385057/7043560691';
  ...
  useEffect(() => {
    const initAdMob = async () => {
      try {
        ...
        console.log('✅ AdMob inicializado no Super Conversor!');
      } catch (error) {
      ...
      <View style={styles.bannerContainer}>
        {bannerError ? (
          <View style={styles.bannerFallback}>
            ...
            <Text style={styles.bannerErrorText}>Anúncio não disponível</Text>
          </View>
        ) : (
          <BannerAd
            ...
            onAdLoaded={() => {
              console.log('✅ Banner carregado no Super Conversor!');
...
const styles = StyleSheet.create({
  ...
  // 👇 Estilos do banner (harmonizados com seu tema)
  bannerContainer: {
    position: 'absolute',
    bottom: 0,
    left: 0,
